...
let headName = document.getElementById('headName').value;
if (headName.length < 2) {
    isValid = false;
    messages.push('X-X Fill Head Name X-X');
}
// Check contact no
let contactNo = document.getElementById('contactNo').value;
if (contactNo.length < 2) {
    isValid = false;
    messages.push('X-X Fill Contact No X-X');
}
// Check voucher no
let voucherNo = document.getElementById('voucherNo').value;
if (voucherNo.length < 2) {
    isValid = false;
    messages.push('X-X Fill Voucher No X-X');
}
...
if (name.length < 2) {
    isValid = false;
    messages.push('X-X Fill Name X-X');
}
// Check contact no
let gender = document.getElementById('gender').value;
if (gender.length < 2) {
    isValid = false;
    messages.push('X-X Fill Gender X-X');
}
// Check voucher no
let passportNo = document.getElementById('passportNo').value;
if (passportNo.length < 2) {
    isValid = false;
    messages.push('X-X Fill Passport No X-X');
}
let visaNo = document.getElementById('visaNo').value;
if (visaNo.length < 2) {
    isValid = false;
    messages.push('X-X Fill Visa No X-X');
}
// Display validation messages
if (!isValid) {
    alert(messages.join('\n'));
...
//    doc.setFontSize(10);
//    doc.text(`Head Name: ${headName}`, 20, 75);
//    doc.setFontSize(10);
//    doc.text(`Voucher No: ${voucherNo}`, 155, 70);
